...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton('how to use me', url='https://t.me/ME_poly_eng/3459')
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/ME_poly_eng') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
